...
for i in range(0,100):
    ...
    #print(Xt_lab)
    model = TwoStageTrAdaBoostR2(hgb(), n_estimators=10, Xt=Xt_lab, yt=yt_lab,
                                 cv=5, n_estimators_fs=10, random_state=0, verbose=1)
    model.fit(Xs, ys)
...
result.to_csv('result/result_TsTrAB.csv')
