...
#size, ne, es = 0.6, 9, lgbm
#size, ne, es = 0.7, 10, lgbm
#size, ne, es = 0.8, 12, lgbm
#size, ne, es = 0.9, 20, hgb
...
Xs = data_s.drop(columns=['Yield',
                          #'LUMO', 'E_S1', 'f_S1', 'E_T1', 'dEST', 'dDM',
                          #'P(dDM) * P(E_S1)', 'P(dDM) * P(dEST)', 'P(dEST) + P(f_S1)', 'P(E_T1) - P(f_S1)',
                          ])
print(Xs)
